     ...
     <table id="despegue-table" class="table no-margin">
          <thead class="bg-primary">          
               ...
               <tr data-id='{{$despegue->id}}'>
                    ...
                    <td>
                         @if($despegue->facturado == 1)
                        <a target="_blank" class='btn btn-default  btn-sm' href='{{action('FacturaController@getPrint', ['despegue'=>$despegue->id])}}'>
