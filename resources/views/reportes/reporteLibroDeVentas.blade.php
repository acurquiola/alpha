								...
								<tbody>
									@if($facturas->count()>0 || $facturasCobradas->count()>0)
										...
										@foreach($facturas as $index2 => $factura)
											<tr>
												<td   style="vertical-align: middle; width: 50px" class="text-center" align="center" align="center">{{$index2+1+$facturasPendientesAnteriores+$facturasCobradas->count()}}</td>
...
<script>
	$(function(){
		...
		var baseImponible=0;
        $('.baseImponible').each(function(index,value){
            baseImponible+=commaToNum($(value).text().trim());
        });
        $('#baseImponibleTotal').text(numToComma(baseImponible));
		...
		var impuestoIva=0;
        $('.impuestoIva').each(function(index,value){
            impuestoIva+=commaToNum($(value).text().trim());
        });
        $('#impuestoIvaTotal').text(numToComma(impuestoIva));


		var ivaRetenido=0;
        $('.ivaRetenido').each(function(index,value){
            ivaRetenido+=commaToNum($(value).text().trim());
        });
        $('#ivaRetenidoTotal').text(numToComma(ivaRetenido));
		...
		$('#export-btn').click(function(e){
	        ...
	        $(table).append('<tr>\
      						...
      						<td colspan="6" align="center"></td>\
      						<td colspan="5" align="left" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">Total Ventas Exportación Afectadas solo Alicuota 0,00</td>\
      						<td colspan="2" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
      						<td colspan="2" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
      						<td colspan="3" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
           			  </tr><tr>\
      						...
      						<td colspan="2" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">'+numToComma(baseImponible)+'</td>\
      						...
      						<td colspan="6" align="center"></td>\
      						<td colspan="5" align="left" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">Total Ventas Internas Afectadas solo Alicuota 0,00</td>\
      						<td colspan="2" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
      						<td colspan="2" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
      						<td colspan="3" align="right" style="font-weight: bold; border-top: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black; font-size: 12px;">0,00</td>\
           			  </tr><tr>\
