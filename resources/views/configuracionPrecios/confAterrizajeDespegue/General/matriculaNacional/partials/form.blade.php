		...
		<div class="box-body">
			...
			<div class="form-group">
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					<label>
						{!! Form::checkbox('aplicar_minimo_diuInt_general', true, null) !!} Aplicar	Mínimo
					</label>
				</div>
			...
			<div class="form-group">
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					<label>
						{!! Form::checkbox('aplicar_minimo_nocInt_general', true, null) !!} Aplicar	Mínimo
					</label>
				</div>
				<div class="input-group  col-md-6"> 
					<div class="input-group-addon">
	...
	<div class="box box-warning aterrizajeBox">
		...
		<div class="box-body">
			...
			<div class="form-group">
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					<label>
						{!! Form::checkbox('aplicar_minimo_diuNac_general', true, null) !!} Aplicar	Mínimo
					</label>
				</div>
				<div class="input-group  col-md-6"> 
					<div class="input-group-addon">
			...
			<div class="form-group">
				<div class="checkbox col-md-6"  style="margin-left: -40px">
					<label>
						{!! Form::checkbox('aplicar_minimo_nocNac_general', true, null) !!} Aplicar	Mínimo
					</label>
				</div>
				<div class="input-group  col-md-6"> 
					<div class="input-group-addon">
