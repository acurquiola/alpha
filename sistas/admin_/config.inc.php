...
$cfg['Servers'][$i]['extension']     = 'mysql';     // The php MySQL extension to use ('mysql' or 'mysqli')<a href="config.inc.php">config.inc.php</a>
...
$cfg['Servers'][$i]['password']      = 'AUYANTEPUY';          // MySQL password (only needed
